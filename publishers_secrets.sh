...
export AWS_ACCESS_KEY_ID="AKIAIKUF3FKUN6INJ4HQ"
export AWS_BUCKET="brave-publishers-dev"
export AWS_REGION="us-west-2"
export AWS_SECRET_ACCESS_KEY="KLSr1Cp1m+x4CZIOF5D8QF+8JePddh4rNnQJ2+iR"

export UPHOLD_AUTHORIZATION_ENDPOINT="https://sandbox.uphold.com/authorize/1e8d9d039b663a7e80a1129f34eb3af3b887946d?scope=cards:write&intention=signup&state=<STATE>"
...
echo '!!!!!!! uphold'
echo $UPHOLD_AUTHORIZATION_ENDPOINT
